...
# ensayo_parcial_1 documentation build
...
from ensayo_parcial_1 import __version__ as release

# -- Project information -----------------------------------------------------

project = "ensayo_parcial_1"
author = "Kedro"
...
htmlhelp_basename = "ensayo_parcial_1doc"
...
latex_documents = [
    (
        master_doc,
        "ensayo_parcial_1.tex",
        "ensayo_parcial_1 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ensayo_parcial_1",
        "Project ensayo_parcial_1 codebase.",
        "Data-Science",
    )
]
